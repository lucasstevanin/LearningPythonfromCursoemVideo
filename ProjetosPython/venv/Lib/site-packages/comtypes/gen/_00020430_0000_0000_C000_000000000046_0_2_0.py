...
IFontDisp = Font
__all__ = [ 'Default', 'VgaColor', 'OLE_HANDLE', 'Font',
           'IPictureDisp', 'Unchecked', 'StdFont', 'FONTNAME',
           'OLE_YPOS_HIMETRIC', 'OLE_OPTEXCLUSIVE', 'IFontEventsDisp',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_XSIZE_HIMETRIC',
           'OLE_YSIZE_CONTAINER', 'IFontDisp', 'OLE_YSIZE_HIMETRIC',
           'OLE_XSIZE_CONTAINER', 'FontEvents',
           'LoadPictureConstants', 'OLE_XSIZE_PIXELS',
           'OLE_XPOS_PIXELS', 'IPicture', 'FONTSTRIKETHROUGH',
           'Checked', 'Picture', 'Color', 'StdPicture', 'FONTBOLD',
           'OLE_CANCELBOOL', 'OLE_COLOR', 'FONTSIZE', 'IFont', 'Gray',
           'OLE_YPOS_CONTAINER', 'OLE_XPOS_HIMETRIC', 'Monochrome',
           'OLE_XPOS_CONTAINER', 'OLE_YPOS_PIXELS', 'OLE_TRISTATE',
